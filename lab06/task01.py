...
##    thresholded = cv2.bitwise_not(thresholded)
    ...
    filter2 = GaussianBlur1(thresh)
    filter3 = medianBlur1(thresh)
    filter4 = bilateralFilter1(thresh)
    ...
    cv2.imshow('GaussianBlured', filter2)
    cv2.imshow('MedianBlured', filter3)
    cv2.imshow('BilateralBlured', filter4)
