...
curvex_k = p1.plot(kalman_rpy_r, pen='g', name='moving average')
curvey_k = p2.plot(kalman_rpy_p, pen='g', name='moving average')
curvez_k = p3.plot(kalman_rpy_y, pen='g', name='moving average')
